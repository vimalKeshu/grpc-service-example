...
public final class WorkerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.worker.TaskRequest,
      TaskResponse> getExecuteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "execute",
      requestType = org.example.worker.TaskRequest.class,
      responseType = TaskResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.worker.TaskRequest,
      TaskResponse> getExecuteMethod() {
    io.grpc.MethodDescriptor<org.example.worker.TaskRequest, TaskResponse> getExecuteMethod;
      ...
      synchronized (WorkerServiceGrpc.class) {
        if ((getExecuteMethod = WorkerServiceGrpc.getExecuteMethod) == null) {
          WorkerServiceGrpc.getExecuteMethod = getExecuteMethod =
              io.grpc.MethodDescriptor.<org.example.worker.TaskRequest, TaskResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "execute"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.worker.TaskRequest.getDefaultInstance()))
  ...
  public static abstract class WorkerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void execute(org.example.worker.TaskRequest request,
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                      org.example.worker.TaskRequest,
                TaskResponse>(
  ...
  public static final class WorkerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<WorkerServiceBlockingStub> {
    ...
    /**
     */
    public TaskResponse execute(org.example.worker.TaskRequest request) {
  ...
  public static final class WorkerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<WorkerServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<TaskResponse> execute(
        org.example.worker.TaskRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXECUTE:
          serviceImpl.execute((org.example.worker.TaskRequest) request,
              (io.grpc.stub.StreamObserver<TaskResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class WorkerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.worker.Worker.getDescriptor();
    }
